...
function cursorAnimation(){
    ...
    videoContainer.addEventListener("click",function(){
        if(flag == 0){
            ...
            vidCrsr.innerHTML = `<i class="ri-pause-large-fill"></i>`
            gsap.to("#video-cursor",{
               scale:0.5,
            })
            flag = 1
            ...
            vidCrsr.innerHTML = `<i class="ri-play-large-fill"></i>`
            gsap.to("#video-cursor",{
              scale:1,
            })
            flag = 0
